...
static const uint8_t vg_glyph_I_boxed[] = {
    VG_FONT_POINT(0, 0), VG_FONT_POINT(8, 0), VG_FONT_POINT(8, 12), VG_FONT_POINT(0, 12), VG_FONT_POINT(0, 0), VG_FONT_LAST
};
